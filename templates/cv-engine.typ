...
#let section_title(title) = {
  v(14pt, weak: true)
  block(width: 100%)[
    #set text(fill: primary_color, weight: "bold", size: 1em)
    #upper(title)
  ]
  v(4pt)
}
...
#grid(
  ...
  [
    ...
    #for job in data.work {
      ...
      grid(
        ...
        "", "",
        [#job.location], [#text(size: 0.8em, weight: "light", fill: rgb("#959595"))[#upper(format_date(job.startDate)) - #upper(format_date(job.endDate))]]
      )
      v(2pt)
      for highlight in job.highlights {
        set text(size: 0.9em, fill: rgb("#959595"))
    ...
    #set text(fill: rgb("#959595"), size: 0.9em)
  ...
  [
    ...
    #for skill_cat in data.skills [
      #v(6pt, weak: true)
      #text(weight: "extrabold")[#skill_cat.name] \
      #v(2pt)
      ...
      #for lang in data.languages [
        *#lang.language*, #lower(lang.fluency) \
      ]
    ]
  ]
)